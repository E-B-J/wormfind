...
This code will:
    Take well views and:
        ...
        DY96:
            ...
            Eventually, also embryo detection - do not have working with spore detections currently - may need to run seperately on another computer!
        FISH:
            For 'good' worms: Get percentage of worm body infected by microsporidia
            Specifically interrogates ribosome rRNA: presence of microsporidia 
            Two metrics: 'fish_percent' - via simple thresholding @ 10,000/65355, and 'fish_pred_percent' - via a spore segmentation network
            
    While running:
         Prints the name of the current image - you can use this to estimate how long you have left.
    Output:
        Object called: 'plate_results' - a list of dictionaries, with each deteected worm being it's own dictionary. 
        You can turn this into a dataframe with pd.DataFrame(plate_results),
        and then save it as a csv or whatever your flavour of datafile is.
...
folders = ["E:/toronto_microscopy/ixmc/OneDrive_1_11-22-2024/alb-3of3-nov14_Plate_2384/TimePoint_1/dapi/one_field/",
             "E:/toronto_microscopy/ixmc/OneDrive_1_11-22-2024/n2vsawr73-nov14_Plate_2385/TimePoint_1/dapi/one_field/"]
...
for plate in folders:
        ...
        for contour in contours:
            ...
            if area > 2000:
                if area < 100000:
                    ...
                    num_DY96_pixels_9k = len(crop_mask_dy96[crop_mask_dy96 > 9000])
                    num_DY96_pixels_8k = len(crop_mask_dy96[crop_mask_dy96 > 8000])
                    num_DY96_pixels_7k = len(crop_mask_dy96[crop_mask_dy96 > 7000])
                    num_DY96_pixels_6k = len(crop_mask_dy96[crop_mask_dy96 > 6000])
                    ...
                    num_fish_pixels_7p5k = len(crop_mask_fish[crop_mask_fish > 7500])
                    ...
                    measurements['dy96_pixels_9k'] = num_DY96_pixels_9k
                    measurements['dy96_pixels_8k'] = num_DY96_pixels_8k
                    measurements['dy96_pixels_7k'] = num_DY96_pixels_7k
                    measurements['dy96_pixels_6k'] = num_DY96_pixels_6k
                    measurements['dy96_pixels_5k'] = num_DY96_pixels_6k
                    ...
                    measurements['fish_pixels_7p5k'] = num_fish_pixels_7p5k
                    measurements['fish_pixels_5k'] = num_fish_pixels_5k
                    measurements['fish_percent_10k'] = 100 * (num_fish_pixels_10k / area)
    ...
    joblib.dump(plate_results, ju1400_1_DAPI + "Nov12_detections_dy96_and_fish.joblib")
