...
root = "E:/toronto_microscopy/ixmc/sep_30_success/JU1400_reps/dapi/one_field/"
pred_path = root.replace('dapi', 'dy96') + "worm_by_worm/noclahe/o_size_preds/"
detections = joblib.load(root + "nov15_results.joblib") # a list right now!
...
for detection in detections:
    if detection['worm_prediction'] == 'good':
        ...
        print('tick')
joblib.dump(detection, root.replace('dapi', 'dy96') + "Nov15_detections_with_Nov26_dy96_ilastik.joblib")