...
def predict_microsporidia(todo, microsporidia_model_path, dy96_folder, microsporidia):
    ...
    #Otherwise, I suppose we should predict microsporidia...
        ...
        return(todo)
#%% To do! Write saver, write all-in-one
...
predict_microsporidia(todo, "C:/Users/ebjam/Documents/GitHub/wormfind/100trees10branches_just_intensity.pickle", "C:/Users/ebjam/Downloads/gui_testers-20230213T211340Z-001/second_detector_testers_96/DY96/", microsporidia = 1)
